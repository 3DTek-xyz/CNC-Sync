...
public partial class DestinationItemViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private bool checkDirectConnectionBeforeVpn;

    [ObservableProperty]
    private bool disconnectVpnWhenFinished;

    public bool HasRequiredVpn => !string.IsNullOrWhiteSpace(RequiredVpnConnectionName);
    public bool UsesVpnBehaviorOptions => HasRequiredVpn && Type != DestinationType.LocalFolder;
    ...
    partial void OnTypeChanged(DestinationType value)
    {
        ...
        OnPropertyChanged(nameof(UsesVpnBehaviorOptions));
    ...
    partial void OnRequiredVpnConnectionNameChanged(string value)
    {
        OnPropertyChanged(nameof(HasRequiredVpn));
        OnPropertyChanged(nameof(UsesVpnBehaviorOptions));
    }
    ...
    public static DestinationItemViewModel FromSettings(DestinationSettings settings) =>
        new()
        {
            ...
            CheckDirectConnectionBeforeVpn = settings.CheckDirectConnectionBeforeVpn,
    ...
    public DestinationSettings ToSettings() =>
        new()
        {
            ...
            CheckDirectConnectionBeforeVpn = CheckDirectConnectionBeforeVpn,
